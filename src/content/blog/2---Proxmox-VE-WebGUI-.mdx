---
heroImage: /src/assets/images/pvewebgui.png
category: Proxmox VE
description: 配置 PVE 仓库，并探索 PVE WebGUI 管理页面
pubDate: 2023-12-31T16:00:00.000Z
tags:
  - Linux
title: 2.配置 & 探索 Proxmox VE WebGUI 管理页面
---

## 1. 登录 PVE Web 管理页面

1. 打开浏览器，输入系统提示的登录地址（例如：这里是 **[https://10.10.1.201:8006](https://10.10.1.201:8006)** ）。
...
在未获得 PVE 企业订阅授权时，每次登录 PVE Web 管理页面时，总是会弹出一个 **No valid subscription** 窗口提示，可以进行如下操作删除这个弹出框。![1.no-valid-subscription](https://raw.githubusercontent.com/Quentinbest/imageupload/master/pve/1.no-valid-subscription.png) 1.切换目录
...
![2.no-valid-subscription](https://raw.githubusercontent.com/Quentinbest/imageupload/master/pve/2.no-valid-subscription.png) 6.重新启动 PVE Web 服务器
